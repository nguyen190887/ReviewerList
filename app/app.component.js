System.register(['angular2/core', 'angular2/router', 'angular2/http', './reviewers/reviewer-list.component', './reviewers/contact-list.component', './reviewers/contact-detail.component', './reviewers/review.service', './tickets/ticket-list.component', './tickets/ticket.service', './release-notes.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, http_1, reviewer_list_component_1, contact_list_component_1, contact_detail_component_1, review_service_1, ticket_list_component_1, ticket_service_1, release_notes_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
